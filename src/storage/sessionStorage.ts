 ...
 * @LastEditTime: 2024-07-16 11:28:53
 ...
 */
export const sessionStorageWrite = (key: string, value: object | string | boolean | number | null | undefined) => {
 ...
 * @returns
 */
export const sessionStorageRead = (key: string): any => {
